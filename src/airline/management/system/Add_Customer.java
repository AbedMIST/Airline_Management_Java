...
public class Add_Customer extends JFrame{ //Third Frame
    ...
    DirStateFactory.Result rs;
            ...
            c = DriverManager.getConnection("jdbc:mysql:///airportdata","root","abed");  
           // c = DriverManager.getConnection("jdbc:mysql://localhost/?user=root&password=rootpassword");  
            //jdbc:mysql://localhost/?user=root&password=rootpassword
            s =c.createStatement(); 
            String query = null;
            rs = (DirStateFactory.Result) s.executeQuery(query);
            ...
            getContentPane().setBackground(new Color(46, 148, 126));
